...
export const GroceryItemComponents = ({item,handleEditItem, handleDeleteItem}) => {
  ...
  return <>
    <li>
      {isEditing?
      <input type="text" value={newItem} onChange={(event)=>setNewItem(event.target.value)}/>:<span>{item.name}</span>}
